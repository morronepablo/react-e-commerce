...
const SingleProduct = () => {
    ...
    return (
        <>
            ...
            <BreadCrumb origin='Home' title='Product Name' />
                        ...
                        <div className="main-product-details">
                            ...
                            <div className="py-3">
                                ...
                                <div className="d-flex align-items-center gap-15">
                                    <div>
                                        <Link><TbGitCompare className='fs-5 me-2' /> Add to Compare</Link>
                                    </div>
                                    <div>
                                        <Link><AiOutlineHeart className='fs-5 me-2' /> Add to Wishlist</Link>
                                    </div>
                                </div>
